...
class Program
{
    static void Main(string[] args)
    {
        ...
        //    new int[,] { { 1, 0 }, { 1, 2 }}
        //    )));
        //System.Console.WriteLine(MaximumScoreFromRemovingSubstrings.MaximumGain("cdbcbbaaabab", 4, 5));
        //System.Console.WriteLine(MaximumScoreFromRemovingSubstrings.MaximumGain("cdbcbbazzzaabab", 4, 5));
        //System.Console.WriteLine(MaximumScoreFromRemovingSubstrings.MaximumGain(File.ReadAllText("MaxScorePerfSample.txt"), 1857, 5279));
        System.Console.WriteLine(MaximumScoreFromRemovingSubstrings.MaximumGain("aaaaaaaaaaaaaaaaaabbbbbbbbbbbbbbbbbbbb", 4, 5));
    }
}